...
#define DS1820_DisableInterrupts()  __disable_irq();
#else
 ...
 ******************************************************************************/
#ifdef DS1820_INTERRUPT_LOCK
#define DS1820_EnableInterrupts()  __enable_irq();
#else
 ...
 * INPUT:      -
 * OUTPUT:     -
 * RETURN:     0 if at least one device is on the 1-wire bus, 1 otherwise
 ******************************************************************************/
 ...
 * RETURN:     uint8_t                 1 if there are more devices on the 1-wire
 *                                  bus, 0 otherwise
 ******************************************************************************/
